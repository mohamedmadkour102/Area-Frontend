...
export const comparisonRows = [
  {
    area: { text: 'Ultra-fast browsing', positive: true },
    webSurge: { text: 'Fast browsing', positive: true },
    hyperView: { text: 'Moderate speeds', positive: false },
  },
  {
    area: { text: 'Advanced AI insights', positive: true },
    webSurge: { text: 'Basic AI recommendations', positive: true },
    hyperView: { text: 'No AI assistance', positive: false },
  },
  {
    area: { text: 'Seamless integration', positive: true },
    webSurge: { text: 'Restricts customization', positive: true },
    hyperView: { text: 'Steep learning curve', positive: false },
  },
  {
    area: { text: 'Full UTF-8 support', positive: true },
    webSurge: { text: 'Potential display errors', positive: false },
    hyperView: { text: 'Partial UTF-8 support', positive: false },
  },
]
